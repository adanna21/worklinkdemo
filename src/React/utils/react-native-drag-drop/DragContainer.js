...
//   componentDidMount() {
//     // if (this.props.teamArray === 0)
//     console.log('all teammodal props!!!', this.context.childContextTypes);
//   }
  ...
  render() {
    ...
    return (
      <Modal transparent={true} supportedOrientations={allOrientations}>
        <TouchableWithoutFeedback onPressIn={this.props.drop}>
          <Animated.View style={this.props.location.getLayout()}>
            <TeamModal>{this.props.content.children}</TeamModal>
          </Animated.View>
        </TouchableWithoutFeedback>
      </Modal>
    );
